...
({
  ...
  SEGMENTS: {
    ...
    "straight": [
      [1, 0.1, "a/scenes/SegmentStraightBase.scene"],

      [0.01, 0.1, "a/scenes/segments/SegmentStraightCCL.scene"], 
      [0.01, 0.1, "a/scenes/segments/SegmentStraightCCM.scene"],
      [0.01, 0.1, "a/scenes/segments/SegmentStraightCCR.scene"],

      [0.1, 0.1, "a/scenes/segments/SegmentStraightCLL.scene"],
      [0.01, 0.1, "a/scenes/segments/SegmentStraightCLM.scene"],
      [0.1, 0.1, "a/scenes/segments/SegmentStraightCLR.scene"],
      [0.001, 1, "a/scenes/segments/SegmentStraightCLA.scene"],

      [0.1, 1, "a/scenes/segments/SegmentStraightNOM.scene"],
      [0.1, 1, "a/scenes/segments/SegmentStraightCOM.scene"],
      [0.1, 1, "a/scenes/segments/SegmentStraightNOA.scene"],
      [0.1, 1, "a/scenes/segments/SegmentStraightCOA.scene"],

      [0.1, 1, "a/scenes/segments/SegmentStraightNPL.scene"],
      [0.1, 1, "a/scenes/segments/SegmentStraightNPR.scene"],
      [0.1, 1, "a/scenes/segments/SegmentStraightCPL.scene"],
      [0.1, 1, "a/scenes/segments/SegmentStraightCPR.scene"],

      [0, 1, "a/scenes/segments/SegmentStraightPTL.scene"],
      [0, 1, "a/scenes/segments/SegmentStraightPTR.scene"]
    ],
    "left": [
      [1, 1, "a/scenes/SegmentLeftBase.scene"]
    ],
    "right": [
      [1, 1, "a/scenes/SegmentRightBase.scene"]
    ],
  },
  ROOMS: {
    "straight": [
      [1, 0.1, "a/scenes/rooms/RoomStraightA.scene"],
      [1, 1, "a/scenes/rooms/RoomStraightB.scene"],
      [0.1, 10, "a/scenes/rooms/RoomStraightC.scene"]
    ],
    "left": [
      [1, 1, "a/scenes/rooms/RoomLeftA.scene"]
    ],
    "right": [
      [1, 1, "a/scenes/rooms/RoomRightA.scene"]
    ],
  },
