  ...
  update() {
    ...
    if (collisionUtils.collidesWithPlayer(this.entity, this.RADIUS)) {
      ...
      for (var i = 0; i < this.SCRIPT_PATHS.length; i++) { 
        ...
        regUtils.addScript(scriptRemoverEntity, "a\\scripts\\RemoveScriptOnEntityAfterDelay.js");
        var scriptRemoverScript = hiber3d.getScript(scriptRemoverEntity, "a\\scripts\\RemoveScriptOnEntityAfterDelay.js");
      ...
      for (var i = 0; i < this.COMPONENTS.length; i++) {
        ...
        regUtils.addScript(componentRemoverEntity, "a\\scripts\\RemoveComponentOnEntityAfterDelay.js");
        var componentRemoverScript = hiber3d.getScript(componentRemoverEntity, "a\\scripts\\RemoveComponentOnEntityAfterDelay.js");
