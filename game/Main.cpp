...
public:
    ...
    void onRegister(Hiber3D::InitContext& context) override {
        ...
        context.getModule<Hiber3D::JavaScriptScriptingModule>().registerFunction<[](Hiber3D::Registry& registry, Hiber3D::Entity entity) { return destroyEntityWithChildrenRecursive(registry, entity); }>(context, "destroyEntityWithChildren");
